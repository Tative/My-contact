...
def test_user_can_create_contact(add_contact_page: AddContact, fill_contact_data: ContactUI, new_user: UserLoginResponse):
...
def test_add_contact_validation_errors(add_contact_page: AddContact, filled_info: dict,
                                       expected_error: str, new_user: UserLoginResponse):
